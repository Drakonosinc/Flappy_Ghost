    ...
    while True:
        ...
        match game.mode_game:
            case {"Training AI": True}:
                best_model = genetic_algorithm_optimized(game, input_size=len(game.get_state()), output_size=1, generations=game.config_AI["generation_value"], population_size=game.config_AI["population_value"], num_trials=game.config_AI["try_for_ai"])
