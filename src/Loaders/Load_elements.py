...
class objects():
    ...
    def load_images(self):
        ...
        self.image_background=pygame.image.load(os.path.join(self.image_path,self.image_direct_path("background","value_background")))
        self.flappy_ghost=pygame.image.load(os.path.join(self.image_path,self.image_direct_path("flyers","value_flyers")))
