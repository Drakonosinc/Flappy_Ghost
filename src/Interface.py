...
class interface(objects):
    ...
    def menu_AI(self):
        ...
        self.screen.blit(self.font2_5.render(f"Attempts By AI\n{self.config.config_AI['try_for_ai']:^{39 if self.config_AI['try_for_ai']<10 else 36}}", True, "White"),(self.width/2+40,self.height/2+50))
        ...
        self.save_model.change_item({"color":self.SKYBLUE if self.config.config_AI["model_save"] else self.RED,"text":"ON" if self.config_AI["model_save"] else "OFF"})
    def buttons_config_AI(self):
        self.increase_generation = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": ">","position": (self.width-140,self.height/2-70),"command1":lambda:self.increase_decrease_variable(self.config_AI,'generation_value')})
        self.decrease_generation = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": "<","position": (self.width-265,self.height/2-70),"command1":lambda:self.increase_decrease_variable(self.config_AI,'generation_value',True,-1)})
        self.increase_population = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": ">","position": (self.width-140,self.height/2+5),"command1":lambda:self.increase_decrease_variable(self.config_AI,'population_value')})
        self.decrease_population = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": "<","position": (self.width-265,self.height/2+5),"command1":lambda:self.increase_decrease_variable(self.config_AI,'population_value',True,-1)})
        self.increase_try_for_ai = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": ">","position": (self.width-140,self.height/2+80),"command1":lambda:self.increase_decrease_variable(self.config_AI,'try_for_ai')})
        self.decrease_try_for_ai = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": "<","position": (self.width-265,self.height/2+80),"command1":lambda:self.increase_decrease_variable(self.config_AI,'try_for_ai',True,-1)})
