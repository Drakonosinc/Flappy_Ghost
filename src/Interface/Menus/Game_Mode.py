...
class GameMode(BaseMenu):
    ...
    def setup_buttons(self):
        ...
        self.buttons['training_ai'] = factory.create_TextButton({"text": "Training AI","position": (35,self.HEIGHT/2-150),"command1":lambda:self.type_game(True),"command2":lambda:self.check_item(self.interface.mode_game,self.interface.SKYBLUE,self.interface.WHITE,"color",**{"Training AI":self.Training_AI_button,"Player":self.player_button,"AI":self.ai_button})})
    def render(self):
