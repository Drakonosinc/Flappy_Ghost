...
class interface(objects):
    ...
    def buttons_sounds(self):
        ...
        self.sound_menu_button = self.button_factory_f2_5.create_TextButton({"text": self.sound_type["sound_menu"],"color":self.sound_type["color_menu"],"position": (35,self.height/2-150),"command1":lambda:(self.sound_on_off("sound_menu","color_menu","value_menu","Sound Menu",self.sound_back,True),self.sound_menu_button.change_item({"color":self.sound_type["color_menu"],"text":self.sound_type["sound_menu"]}))})
        self.sound_game_button = self.button_factory_f2_5.create_TextButton({"text": self.sound_type["sound_Game"],"color":self.sound_type["color_game"],"position": (35,self.height/2-100),"command1":lambda:(self.sound_on_off("sound_Game","color_game","value_game","Sound Game",self.sound_back_game),self.sound_game_button.change_item({"color":self.sound_type["color_game"],"text":self.sound_type["sound_Game"]}))})
