...
class interface(objects):
    ...
    def buttons_config_AI(self):
        self.increase_generation = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": ">","position": (self.width-150,self.height/2-70),"command1":lambda:self.increase_decrease_variable(self.config_AI,'generation_value')})
        self.decrease_generation = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": "<","position": (self.width-250,self.height/2-70),"command1":lambda:self.increase_decrease_variable(self.config_AI,'generation_value',True,-1)})
        self.increase_population = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": ">","position": (self.width-150,self.height/2+5),"command1":lambda:self.increase_decrease_variable(self.config_AI,'population_value')})
        self.decrease_population = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": "<","position": (self.width-250,self.height/2+5),"command1":lambda:self.increase_decrease_variable(self.config_AI,'population_value',True,-1)})
        self.increase_try_for_ai = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": ">","position": (self.width-150,self.height/2+80),"command1":lambda:self.increase_decrease_variable(self.config_AI,'try_for_ai')})
        self.decrease_try_for_ai = self.button_factory_f2_5.create_TextButton({"font":self.font3_5,"text": "<","position": (self.width-250,self.height/2+80),"command1":lambda:self.increase_decrease_variable(self.config_AI,'try_for_ai',True,-1)})
